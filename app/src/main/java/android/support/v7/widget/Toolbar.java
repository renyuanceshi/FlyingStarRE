...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mExpandedActionView)) {
            ...
            i6 = layoutChildLeft(this.mExpandedActionView, max2, iArr, minimumHeight);
        }
        if (!shouldLayout(this.mLogoView)) {
            i7 = min;
            i8 = i6;
        } else if (z2) {
            i7 = layoutChildRight(this.mLogoView, min, iArr, minimumHeight);
            i8 = i6;
        } else {
            i7 = min;
            i8 = layoutChildLeft(this.mLogoView, i6, iArr, minimumHeight);
        }
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            if (z2) {
                ...
                if (shouldLayout2) {
                    ...
                    this.mSubtitleTextView.layout(i7 - this.mSubtitleTextView.getMeasuredWidth(), i20, i7, this.mSubtitleTextView.getMeasuredHeight() + i20);
                    int i21 = layoutParams5.bottomMargin;
                    i14 = i7 - this.mTitleMarginEnd;
                } else {
                    i14 = i7;
                }
                if (z3) {
                ...
                if (shouldLayout2) {
                    ...
                    this.mSubtitleTextView.layout(i8, i23, measuredWidth3, this.mSubtitleTextView.getMeasuredHeight() + i23);
        ...
        for (int i26 = 0; i26 < size; i26++) {
            i25 = layoutChildLeft(this.mTempViews.get(i26), i25, iArr, minimumHeight);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i27 = 0; i27 < size2; i27++) {
            i7 = layoutChildRight(this.mTempViews.get(i27), i7, iArr, minimumHeight);
        }
        ...
        for (int i31 = 0; i31 < size3; i31++) {
            i30 = layoutChildLeft(this.mTempViews.get(i31), i30, iArr, minimumHeight);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType != 0) {
                ...
                i6 = ViewUtils.combineMeasuredStates(i9, ViewCompat.getMeasuredState(childAt));
            }
            i9 = i6;
            i10++;
            i4 = i5;
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = ViewCompat.resolveSizeAndState(Math.max(i11 + max3 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i, -16777216 & i9);
