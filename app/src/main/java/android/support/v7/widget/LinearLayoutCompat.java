...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void measureVertical(int i, int i2) {
        ...
        while (i14 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (mode2 == 1073741824 && layoutParams.height == 0 && layoutParams.weight > 0.0f) {
                    ...
                    int i17 = i16;
                    measureChildBeforeLayout(virtualChildAt, i14, i, 0, i2, f4 == 0.0f ? this.mTotalLength : 0);
                    ...
                    if (z8) {
                        z = z7;
                        i6 = Math.max(measuredHeight, i13);
                    } else {
                        z = z7;
                        i6 = i13;
                    }
                ...
                if (i14 >= i12 || layoutParams.weight <= 0.0f) {
                    ...
                    if (layoutParams.weight > 0.0f) {
                        i7 = Math.max(i11, z9 ? i19 : measuredWidth);
                        max2 = i10;
                    } else {
                        if (z9) {
                            measuredWidth = i19;
                        }
                        max2 = Math.max(i10, measuredWidth);
                        i7 = i11;
                    }
                    i14 += getChildrenSkipCount(virtualChildAt, i14);
                    z4 = z;
        ...
        if (z8 && (mode2 == Integer.MIN_VALUE || mode2 == 0)) {
            ...
            while (i20 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    LayoutParams layoutParams2 = (LayoutParams) virtualChildAt2.getLayoutParams();
                    int i21 = this.mTotalLength;
                    this.mTotalLength = Math.max(i21, layoutParams2.bottomMargin + i21 + i13 + layoutParams2.topMargin + getNextLocationOffset(virtualChildAt2));
                    i5 = i20;
                }
                i20 = i5 + 1;
            }
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (layoutParams3.height == 0 && mode2 == 1073741824) {
                            virtualChildAt3.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(i27 > 0 ? i27 : 0, 1073741824));
                        } else {
                            int measuredHeight2 = virtualChildAt3.getMeasuredHeight() + i27;
                    ...
                    int i28 = layoutParams3.rightMargin + layoutParams3.leftMargin;
                    int measuredWidth2 = virtualChildAt3.getMeasuredWidth() + i28;
                    max = Math.max(i24, measuredWidth2);
                    int max4 = Math.max(i25, mode != 1073741824 && layoutParams3.width == -1 ? i28 : measuredWidth2);
                    z10 = z10 && layoutParams3.width == -1;
                    int i29 = this.mTotalLength;
                    this.mTotalLength = Math.max(i29, layoutParams3.bottomMargin + virtualChildAt3.getMeasuredHeight() + i29 + layoutParams3.topMargin + getNextLocationOffset(virtualChildAt3));
                    f = f5;
                    i25 = max4;
                }
                f5 = f;
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(i4 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, i9), resolveSizeAndState);
        if (z6) {
