...
public interface zzow extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzow {
        ...
        private static class C0129zza implements zzow {
        ...
        public static zzow zzbR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzow)) ? new C0129zza(iBinder) : (zzow) queryLocalInterface;
        }
