...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C0202zza implements zzt {
        ...
        public static zzt zzcP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C0202zza(iBinder) : (zzt) queryLocalInterface;
        }
