...
public class zzs implements Parcelable.Creator<SubscribeRequest> {
    static void zza(SubscribeRequest subscribeRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 3, (Parcelable) subscribeRequest.zzbcU, i, false);
        zzb.zza(parcel, 4, subscribeRequest.zzED(), false);
        zzb.zza(parcel, 5, (Parcelable) subscribeRequest.zzbcZ, i, false);
        zzb.zza(parcel, 6, (Parcelable) subscribeRequest.zzbda, i, false);
        ...
        zzb.zza(parcel, 14, (Parcelable) subscribeRequest.zzbcs, i, false);
        zzb.zzI(parcel, zzav);
    }
