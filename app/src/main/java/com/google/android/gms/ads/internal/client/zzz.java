...
public interface zzz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzz {
        ...
        private static class C0010zza implements zzz {
        ...
        public static zzz zzp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzz)) ? new C0010zza(iBinder) : (zzz) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(zzd.zza.zzbs(parcel.readStrongBinder()), parcel.readInt());
