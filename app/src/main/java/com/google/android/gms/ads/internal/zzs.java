...
public final class zzs implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzs(Context context2, AdSizeParcel adSizeParcel, String str, VersionInfoParcel versionInfoParcel) {
        this(context2, adSizeParcel, str, versionInfoParcel, (zzan) null);
    }
    ...
    zzs(Context context2, AdSizeParcel adSizeParcel, String str, VersionInfoParcel versionInfoParcel, zzan zzan) {
        ...
        if (adSizeParcel.zzui || adSizeParcel.zzuk) {
            ...
            this.zzrm = new zza(context2, this, this);
        ...
        this.zzrk = zzan == null ? new zzan(new zzh(this)) : zzan;
