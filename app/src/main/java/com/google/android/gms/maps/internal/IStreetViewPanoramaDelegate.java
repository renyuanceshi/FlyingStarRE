...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaDelegate {
        ...
        private static class C0178zza implements IStreetViewPanoramaDelegate {
        ...
        public static IStreetViewPanoramaDelegate zzcZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaDelegate)) ? new C0178zza(iBinder) : (IStreetViewPanoramaDelegate) queryLocalInterface;
        }
