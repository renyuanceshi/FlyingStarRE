...
public interface zzko extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzko {
        ...
        private static class C0097zza implements zzko {
        ...
        public static zzko zzak(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzko)) ? new C0097zza(iBinder) : (zzko) queryLocalInterface;
        }
