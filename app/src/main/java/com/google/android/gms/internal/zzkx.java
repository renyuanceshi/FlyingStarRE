...
public interface zzkx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkx {
        ...
        private static class C0101zza implements zzkx {
        ...
        public static zzkx zzau(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkx)) ? new C0101zza(iBinder) : (zzkx) queryLocalInterface;
        }
