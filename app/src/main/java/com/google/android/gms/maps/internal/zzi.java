...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C0191zza implements zzi {
        ...
        public static zzi zzcE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C0191zza(iBinder) : (zzi) queryLocalInterface;
        }
