...
public class zze {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            if (!zzmu.zzaw(context)) {
                try {
                    zzd.zza zza = zzoO.zza(packageManager.getPackageInfo("com.android.vending", 8256), zzd.C0040zzd.zzafK);
                    if (zza == null) {
            ...
            } else if (zzoO.zza(packageInfo, zzd.C0040zzd.zzafK) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    public static boolean zzb(PackageManager packageManager) {
        ...
        synchronized (zzqy) {
            if (zzafN == -1) {
                try {
                    if (zzf.zzoO().zza(packageManager.getPackageInfo("com.google.android.gms", 64), zzd.C0040zzd.zzafK[1]) != null) {
                        zzafN = 1;
                    } else {
                        zzafN = 0;
                    }
