...
public interface zzfc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfc {
        ...
        private static class C0086zza implements zzfc {
        ...
        public static zzfc zzJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfc)) ? new C0086zza(iBinder) : (zzfc) queryLocalInterface;
        }
