...
public interface zzfa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfa {
        ...
        private static class C0084zza implements zzfa {
        ...
        public static zzfa zzH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfa)) ? new C0084zza(iBinder) : (zzfa) queryLocalInterface;
        }
