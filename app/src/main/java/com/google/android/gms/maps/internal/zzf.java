...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        private static class C0188zza implements zzf {
        ...
        public static zzf zzcB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C0188zza(iBinder) : (zzf) queryLocalInterface;
        }
