...
public interface zzcj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcj {
        ...
        private static class C0072zza implements zzcj {
        ...
        public static zzcj zzu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcj)) ? new C0072zza(iBinder) : (zzcj) queryLocalInterface;
        }
