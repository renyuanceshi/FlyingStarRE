...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0014zza implements zzk {
        ...
        public static zzk zzY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C0014zza(iBinder) : (zzk) queryLocalInterface;
        }
