...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C0056zza implements zzn {
        ...
        public static zzn zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzn)) ? new C0056zza(iBinder) : (zzn) queryLocalInterface;
        }
