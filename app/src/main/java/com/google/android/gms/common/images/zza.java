...
public abstract class zza {
    ...
    static final class C0032zza {
        public final Uri uri;

        public C0032zza(Uri uri2) {
            this.uri = uri2;
        }

        public boolean equals(Object obj) {
            if (!(obj instanceof C0032zza)) {
                return false;
            }
            if (this == obj) {
                return true;
            }
            return zzw.equal(((C0032zza) obj).uri, this.uri);
        }
