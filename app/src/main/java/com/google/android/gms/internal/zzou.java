...
public interface zzou extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzou {
        ...
        private static class C0127zza implements zzou {
        ...
        public static zzou zzbP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzou)) ? new C0127zza(iBinder) : (zzou) queryLocalInterface;
        }
