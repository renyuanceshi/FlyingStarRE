...
public interface zzry extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzry {
        ...
        private static class C0150zza implements zzry {
        ...
        public static zzry zzek(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzry)) ? new C0150zza(iBinder) : (zzry) queryLocalInterface;
        }
