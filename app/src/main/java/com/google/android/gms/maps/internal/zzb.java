...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C0184zza implements zzb {
        ...
        public static zzb zzct(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C0184zza(iBinder) : (zzb) queryLocalInterface;
        }
