...
public interface zzkf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkf {
        ...
        private static class C0095zza implements zzkf {
            ...
            public void zza(GetRecentContextCall.Request request, zzkg zzkg) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzkg != null ? zzkg.asBinder() : null);
            ...
            public void zza(zzkg zzkg) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            ...
            public void zza(zzkg zzkg, String str, String str2) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            ...
            public void zza(zzkg zzkg, String str, UsageInfo[] usageInfoArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            ...
            public void zza(zzkg zzkg, boolean z) throws RemoteException {
                int i = 0;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public void zzb(zzkg zzkg) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        ...
        public static zzkf zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkf)) ? new C0095zza(iBinder) : (zzkf) queryLocalInterface;
        }
    ...
    void zza(GetRecentContextCall.Request request, zzkg zzkg) throws RemoteException;

    void zza(zzkg zzkg) throws RemoteException;

    void zza(zzkg zzkg, String str, String str2) throws RemoteException;

    void zza(zzkg zzkg, String str, UsageInfo[] usageInfoArr) throws RemoteException;

    void zza(zzkg zzkg, boolean z) throws RemoteException;

    void zzb(zzkg zzkg) throws RemoteException;
}
