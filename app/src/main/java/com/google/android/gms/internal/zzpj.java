...
public interface zzpj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpj {
        ...
        private static class C0131zza implements zzpj {
        ...
        public static zzpj zzbT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpj)) ? new C0131zza(iBinder) : (zzpj) queryLocalInterface;
        }
