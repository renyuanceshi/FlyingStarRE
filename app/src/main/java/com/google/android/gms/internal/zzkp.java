...
public interface zzkp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkp {
        ...
        private static class C0098zza implements zzkp {
            ...
            public void zza(zzko zzko) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appinvite.internal.IAppInviteService");
                    obtain.writeStrongBinder(zzko != null ? zzko.asBinder() : null);
            ...
            public void zza(zzko zzko, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appinvite.internal.IAppInviteService");
            ...
            public void zzb(zzko zzko, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appinvite.internal.IAppInviteService");
        ...
        public static zzkp zzal(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkp)) ? new C0098zza(iBinder) : (zzkp) queryLocalInterface;
        }
    ...
    void zza(zzko zzko, String str) throws RemoteException;

    void zzb(zzko zzko, String str) throws RemoteException;
}
