    ...
    public static class SubstringEntity implements SafeParcelable, AutocompletePrediction.Substring {
        ...
        public boolean equals(Object obj) {
            if (this != obj) {
                ...
                if (!zzw.equal(Integer.valueOf(this.mOffset), Integer.valueOf(substringEntity.mOffset)) || !zzw.equal(Integer.valueOf(this.mLength), Integer.valueOf(substringEntity.mLength))) {
                    return false;
                }
            }
            return true;
