...
public interface zzct extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzct {
        ...
        private static class C0079zza implements zzct {
        ...
        public static zzct zzB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzct)) ? new C0079zza(iBinder) : (zzct) queryLocalInterface;
        }
