...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C0057zza implements zzo {
        ...
        public static zzo zzbq(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzo)) ? new C0057zza(iBinder) : (zzo) queryLocalInterface;
        }
