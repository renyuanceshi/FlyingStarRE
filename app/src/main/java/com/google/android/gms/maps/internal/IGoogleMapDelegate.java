...
public interface IGoogleMapDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IGoogleMapDelegate {
        ...
        private static class C0173zza implements IGoogleMapDelegate {
        ...
        public static IGoogleMapDelegate zzcv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IGoogleMapDelegate)) ? new C0173zza(iBinder) : (IGoogleMapDelegate) queryLocalInterface;
        }
