...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0035zza implements zzq {
        ...
        public static zzq zzaQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzq)) ? new C0035zza(iBinder) : (zzq) queryLocalInterface;
        }
