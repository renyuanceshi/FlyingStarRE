...
public class zzn extends zzd {
    ...
    public java.lang.String zzac(android.content.Context r7) {
        /*
            ...
            r1 = 36
            byte[] r3 = new byte[r1]     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            r1 = 0
            int r4 = r3.length     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            int r4 = r2.read(r3, r1, r4)     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            int r1 = r2.available()     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            if (r1 <= 0) goto L_0x0036
            java.lang.String r1 = "clientId file seems corrupted, deleting it."
            r6.zzbg(r1)     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            r2.close()     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            java.lang.String r1 = "gaClientId"
            r7.deleteFile(r1)     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
        ...
        L_0x0054:
            r2.close()     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            java.lang.String r1 = new java.lang.String     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            r5 = 0
            r1.<init>(r3, r5, r4)     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
            java.lang.String r3 = "Read client id from disk"
            r6.zza(r3, r1)     // Catch:{ FileNotFoundException -> 0x00aa, IOException -> 0x00ac }
        ...
        L_0x0081:
            ...
            r6.zze(r3, r1)     // Catch:{ all -> 0x00a7 }
            java.lang.String r1 = "gaClientId"
            r7.deleteFile(r1)     // Catch:{ all -> 0x00a7 }
            if (r2 == 0) goto L_0x002e
