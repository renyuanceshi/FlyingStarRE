...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C0066zza implements zzb {
        ...
        public static zzb zzcd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C0066zza(iBinder) : (zzb) queryLocalInterface;
        }
