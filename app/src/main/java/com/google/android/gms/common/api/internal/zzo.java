...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C0031zza implements zzo {
        ...
        public static zzo zzaN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzo)) ? new C0031zza(iBinder) : (zzo) queryLocalInterface;
        }
