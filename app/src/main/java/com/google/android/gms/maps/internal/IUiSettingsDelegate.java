...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IUiSettingsDelegate {
        ...
        private static class C0181zza implements IUiSettingsDelegate {
        ...
        public static IUiSettingsDelegate zzdc(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C0181zza(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
