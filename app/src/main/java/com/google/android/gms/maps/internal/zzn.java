...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C0196zza implements zzn {
        ...
        public static zzn zzcJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzn)) ? new C0196zza(iBinder) : (zzn) queryLocalInterface;
        }
