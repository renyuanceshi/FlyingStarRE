...
public interface zzch extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzch {
        ...
        private static class C0071zza implements zzch {
        ...
        public static zzch zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzch)) ? new C0071zza(iBinder) : (zzch) queryLocalInterface;
        }
