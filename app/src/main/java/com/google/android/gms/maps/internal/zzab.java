...
public interface zzab extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzab {
        ...
        private static class C0183zza implements zzab {
        ...
        public static zzab zzcY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzab)) ? new C0183zza(iBinder) : (zzab) queryLocalInterface;
        }
