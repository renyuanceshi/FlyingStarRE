...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C0207zza implements zzy {
        ...
        public static zzy zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0207zza(iBinder) : (zzy) queryLocalInterface;
        }
