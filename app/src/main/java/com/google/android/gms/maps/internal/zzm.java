...
public interface zzm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzm {
        ...
        private static class C0195zza implements zzm {
        ...
        public static zzm zzcI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzm)) ? new C0195zza(iBinder) : (zzm) queryLocalInterface;
        }
