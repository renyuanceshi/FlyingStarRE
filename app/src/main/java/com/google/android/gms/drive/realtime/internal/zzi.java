...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C0051zza implements zzi {
        ...
        public static zzi zzbk(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C0051zza(iBinder) : (zzi) queryLocalInterface;
        }
