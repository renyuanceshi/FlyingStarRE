...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C0204zza implements zzv {
        ...
        public static zzv zzcR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C0204zza(iBinder) : (zzv) queryLocalInterface;
        }
