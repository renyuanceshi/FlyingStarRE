...
public class zzdg extends zzdd {
    ...
    private void zzb(com.google.android.gms.analytics.Tracker r8, java.util.Map<java.lang.String, com.google.android.gms.internal.zzag.zza> r9) {
        ...
        L_0x00c1:
            ...
            java.util.Map r0 = (java.util.Map) r0
            com.google.android.gms.analytics.ecommerce.Promotion r0 = r7.zzZ(r0)     // Catch:{ RuntimeException -> 0x00d5 }
            r3.addPromotion(r0)     // Catch:{ RuntimeException -> 0x00d5 }
            goto L_0x00c1
        L_0x00d5:
            r0 = move-exception
        ...
        L_0x0148:
            ...
            com.google.android.gms.analytics.ecommerce.Product r2 = r7.zzaa(r2)     // Catch:{ RuntimeException -> 0x015c }
            r3.addProduct(r2)     // Catch:{ RuntimeException -> 0x015c }
            goto L_0x0148
        L_0x015c:
            r2 = move-exception
            java.lang.StringBuilder r5 = new java.lang.StringBuilder
        ...
        L_0x0181:
            ...
            boolean r2 = r1.containsKey(r2)     // Catch:{ RuntimeException -> 0x01a7 }
            if (r2 == 0) goto L_0x01a0
            java.lang.String r2 = "actionField"
            java.lang.Object r1 = r1.get(r2)     // Catch:{ RuntimeException -> 0x01a7 }
            java.util.Map r1 = (java.util.Map) r1     // Catch:{ RuntimeException -> 0x01a7 }
            com.google.android.gms.analytics.ecommerce.ProductAction r0 = r7.zzd(r0, r1)     // Catch:{ RuntimeException -> 0x01a7 }
        L_0x0195:
            r3.setProductAction(r0)     // Catch:{ RuntimeException -> 0x01a7 }
        L_0x0198:
            java.util.Map r0 = r3.build()
            r8.send(r0)
            return
        L_0x01a0:
            com.google.android.gms.analytics.ecommerce.ProductAction r1 = new com.google.android.gms.analytics.ecommerce.ProductAction     // Catch:{ RuntimeException -> 0x01a7 }
            r1.<init>(r0)     // Catch:{ RuntimeException -> 0x01a7 }
            r0 = r1
            goto L_0x0195
        L_0x01a7:
            r0 = move-exception
