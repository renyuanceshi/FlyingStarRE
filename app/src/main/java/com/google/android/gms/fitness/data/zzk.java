...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0061zza implements zzk {
        ...
        public static zzk zzbt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C0061zza(iBinder) : (zzk) queryLocalInterface;
        }
