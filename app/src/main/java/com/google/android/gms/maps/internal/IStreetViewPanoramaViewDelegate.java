...
public interface IStreetViewPanoramaViewDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaViewDelegate {
        ...
        private static class C0180zza implements IStreetViewPanoramaViewDelegate {
        ...
        public static IStreetViewPanoramaViewDelegate zzdb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaViewDelegate)) ? new C0180zza(iBinder) : (IStreetViewPanoramaViewDelegate) queryLocalInterface;
        }
