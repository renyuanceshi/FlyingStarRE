...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class C0177zza implements IProjectionDelegate {
        ...
        public static IProjectionDelegate zzcX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0177zza(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
