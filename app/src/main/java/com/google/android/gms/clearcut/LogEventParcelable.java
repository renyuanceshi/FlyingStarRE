...
public class LogEventParcelable implements SafeParcelable {
    ...
    public final zzb.C0029zzb zzafl;
    public final zzb.C0029zzb zzafm;
    ...
    public LogEventParcelable(PlayLoggerContext playLoggerContext, zzsz.zzd zzd, zzb.C0029zzb zzb, zzb.C0029zzb zzb2, int[] iArr) {
        this.versionCode = 1;
        this.zzafh = playLoggerContext;
        this.zzafk = zzd;
        this.zzafl = zzb;
