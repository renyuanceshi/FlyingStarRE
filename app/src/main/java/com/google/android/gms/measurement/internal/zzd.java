...
public class zzd extends zzy {
    ...
    public String zzH(String str, String str2) {
        ...
        builder.scheme(zzl.zzaWe.get()).authority(zzl.zzaWf.get()).path("config/app/" + str).appendQueryParameter("app_instance_id", str2).appendQueryParameter("platform", "android").appendQueryParameter("gmp_version", String.valueOf(zzBp()));
