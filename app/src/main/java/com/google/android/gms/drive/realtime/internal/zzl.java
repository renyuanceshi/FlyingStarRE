...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C0054zza implements zzl {
        ...
        public static zzl zzbn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C0054zza(iBinder) : (zzl) queryLocalInterface;
        }
