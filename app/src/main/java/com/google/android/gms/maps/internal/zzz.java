...
public interface zzz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzz {
        ...
        private static class C0208zza implements zzz {
        ...
        public static zzz zzcV(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzz)) ? new C0208zza(iBinder) : (zzz) queryLocalInterface;
        }
