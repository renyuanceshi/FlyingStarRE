...
public interface zzrx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrx {
        ...
        private static class C0149zza implements zzrx {
        ...
        public static zzrx zzej(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrx)) ? new C0149zza(iBinder) : (zzrx) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zza(zzd.zza.zzbs(parcel.readStrongBinder()), parcel.readInt() != 0 ? WalletFragmentOptions.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
