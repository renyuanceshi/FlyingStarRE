...
public interface zzlx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlx {
        ...
        private static class C0108zza implements zzlx {
        ...
        public static zzlx zzaL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlx)) ? new C0108zza(iBinder) : (zzlx) queryLocalInterface;
        }
