...
public interface zzoj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoj {
        ...
        private static class C0116zza implements zzoj {
        ...
        public static zzoj zzbE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzoj)) ? new C0116zza(iBinder) : (zzoj) queryLocalInterface;
        }
