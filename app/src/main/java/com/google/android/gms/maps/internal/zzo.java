...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C0197zza implements zzo {
        ...
        public static zzo zzcK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzo)) ? new C0197zza(iBinder) : (zzo) queryLocalInterface;
        }
