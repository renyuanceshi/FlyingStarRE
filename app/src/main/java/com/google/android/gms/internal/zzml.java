...
public interface zzml extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzml {
        ...
        private static class C0112zza implements zzml {
        ...
        public static zzml zzaY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzml)) ? new C0112zza(iBinder) : (zzml) queryLocalInterface;
        }
