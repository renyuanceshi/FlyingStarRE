...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class C0187zza implements zze {
        ...
        public static zze zzcA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zze)) ? new C0187zza(iBinder) : (zze) queryLocalInterface;
        }
