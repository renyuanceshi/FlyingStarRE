...
public final class zzen {
    ...
    public zzen(JSONObject jSONObject) throws JSONException {
        ...
        this.zzBC = jSONObject.optString("allocation_id", (String) null);
        ...
        this.zzBJ = jSONObject.optString("html_template", (String) null);
        this.zzBK = jSONObject.optString("ad_base_url", (String) null);
        ...
        this.zzBN = optJSONObject4 != null ? optJSONObject4.toString() : str;
    }
}
