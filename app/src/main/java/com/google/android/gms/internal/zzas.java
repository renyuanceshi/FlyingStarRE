...
public interface zzas extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzas {
        ...
        private static class C0067zza implements zzas {
        ...
        public static zzas zza(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzas)) ? new C0067zza(iBinder) : (zzas) queryLocalInterface;
        }
