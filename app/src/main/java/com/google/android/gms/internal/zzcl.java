...
public interface zzcl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcl {
        ...
        private static class C0074zza implements zzcl {
        ...
        public static zzcl zzw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcl)) ? new C0074zza(iBinder) : (zzcl) queryLocalInterface;
        }
