...
public interface zzfv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfv {
        ...
        private static class C0087zza implements zzfv {
        ...
        public static zzfv zzL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfv)) ? new C0087zza(iBinder) : (zzfv) queryLocalInterface;
        }
