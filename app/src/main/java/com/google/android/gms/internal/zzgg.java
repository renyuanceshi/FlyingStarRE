...
public interface zzgg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgg {
        ...
        private static class C0093zza implements zzgg {
        ...
        public static zzgg zzS(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgg)) ? new C0093zza(iBinder) : (zzgg) queryLocalInterface;
        }
