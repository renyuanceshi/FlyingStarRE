...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class C0192zza implements zzj {
        ...
        public static zzj zzcF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C0192zza(iBinder) : (zzj) queryLocalInterface;
        }
