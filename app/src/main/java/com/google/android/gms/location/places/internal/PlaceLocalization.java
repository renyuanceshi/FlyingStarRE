...
public final class PlaceLocalization implements SafeParcelable {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!zzw.equal(this.name, placeLocalization.name) || !zzw.equal(this.address, placeLocalization.address) || !zzw.equal(this.zzaQO, placeLocalization.zzaQO) || !zzw.equal(this.zzaQP, placeLocalization.zzaQP) || !zzw.equal(this.zzaQQ, placeLocalization.zzaQQ)) {
                return false;
            }
        }
        return true;
