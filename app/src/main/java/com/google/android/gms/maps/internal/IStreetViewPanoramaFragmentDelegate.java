...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class C0179zza implements IStreetViewPanoramaFragmentDelegate {
        ...
        public static IStreetViewPanoramaFragmentDelegate zzda(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0179zza(iBinder) : (IStreetViewPanoramaFragmentDelegate) queryLocalInterface;
        }
