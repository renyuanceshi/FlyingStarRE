...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C0205zza implements zzw {
        ...
        public static zzw zzcS(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzw)) ? new C0205zza(iBinder) : (zzw) queryLocalInterface;
        }
