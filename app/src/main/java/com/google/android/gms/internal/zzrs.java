...
public class zzrs {
    ...
    private static zzag.zza zza(int i, zzaf.zzf zzf2, zzag.zza[] zzaArr, Set<Integer> set) throws zzg {
        ...
        zzag.zza zza3 = (zzag.zza) zza(zzf2.zziI, i, "values");
        if (zzaArr[i] != null) {
            return zzaArr[i];
        }
        zzag.zza zza4 = null;
        ...
        switch (zza3.type) {
            ...
            case 2:
                ...
                int i3 = 0;
                while (i3 < length) {
                    zza2.zzjy[i2] = zza(iArr[i3], zzf2, zzaArr, set);
                    i3++;
                    i2++;
                }
                break;
            case 3:
                ...
                int i5 = 0;
                while (i5 < length2) {
                    zza2.zzjz[i4] = zza(iArr2[i5], zzf2, zzaArr, set);
                    i5++;
                    i4++;
                }
                int[] iArr3 = zzp2.zzjl;
                ...
                int i7 = 0;
                while (i7 < length3) {
                    zza2.zzjA[i6] = zza(iArr3[i7], zzf2, zzaArr, set);
                    i7++;
                    i6++;
                }
                break;
            case 4:
                zza4 = zzo(zza3);
                zza4.zzjB = zzdf.zzg(zza(zzp(zza3).zzjo, zzf2, zzaArr, set));
                break;
            case 7:
                zza2 = zzo(zza3);
                zzaf.zzh zzp3 = zzp(zza3);
                zza2.zzjF = new zzag.zza[zzp3.zzjn.length];
                int i8 = 0;
                for (int zza5 : zzp3.zzjn) {
                    zza2.zzjF[i8] = zza(zza5, zzf2, zzaArr, set);
                    i8++;
                }
                break;
        }
