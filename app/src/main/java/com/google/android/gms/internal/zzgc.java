...
public interface zzgc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgc {
        ...
        private static class C0089zza implements zzgc {
        ...
        public static zzgc zzO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgc)) ? new C0089zza(iBinder) : (zzgc) queryLocalInterface;
        }
