...
public interface zzge extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzge {
        ...
        private static class C0091zza implements zzge {
        ...
        public static zzge zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzge)) ? new C0091zza(iBinder) : (zzge) queryLocalInterface;
        }
