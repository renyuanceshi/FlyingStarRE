...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C0060zza implements zzd {
        ...
        public static zzd zzbs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzd)) ? new C0060zza(iBinder) : (zzd) queryLocalInterface;
        }
