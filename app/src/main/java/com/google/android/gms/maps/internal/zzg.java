...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        private static class C0189zza implements zzg {
        ...
        public static zzg zzcC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzg)) ? new C0189zza(iBinder) : (zzg) queryLocalInterface;
        }
