...
public final class AnalyticsService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, final int i2) {
        ...
        if (zzaa.zzjn().zzkr()) {
            zzjm.zza("Device AnalyticsService called. startId, action", Integer.valueOf(i2), action);
        } else {
            zzjm.zza("Local AnalyticsService called. startId, action", Integer.valueOf(i2), action);
        }
