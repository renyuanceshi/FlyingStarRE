...
public interface zzly extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzly {
        ...
        private static class C0109zza implements zzly {
        ...
        public static zzly zzaM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzly)) ? new C0109zza(iBinder) : (zzly) queryLocalInterface;
        }
