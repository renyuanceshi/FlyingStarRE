...
public interface zzsb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsb {
        ...
        private static class C0154zza implements zzsb {
        ...
        public static zzsb zzen(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsb)) ? new C0154zza(iBinder) : (zzsb) queryLocalInterface;
        }
