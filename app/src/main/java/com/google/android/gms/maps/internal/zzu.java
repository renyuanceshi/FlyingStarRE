...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C0203zza implements zzu {
        ...
        public static zzu zzcQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C0203zza(iBinder) : (zzu) queryLocalInterface;
        }
