...
public class zza {
    ...
    public static abstract class C0030zza<R extends Result, A extends Api.zzb> extends zzb<R> implements zzb<R>, zzj.zze<A> {
        private final Api.zzc<A> zzaeE;
        private AtomicReference<zzj.zzd> zzagH = new AtomicReference<>();

        protected C0030zza(Api.zzc<A> zzc, GoogleApiClient googleApiClient) {
