...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0199zza implements zzq {
        ...
        public static zzq zzcM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzq)) ? new C0199zza(iBinder) : (zzq) queryLocalInterface;
        }
