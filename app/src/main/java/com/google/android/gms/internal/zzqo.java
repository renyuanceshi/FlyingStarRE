...
public interface zzqo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqo {
        ...
        private static class C0143zza implements zzqo {
        ...
        public static zzqo zzdK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqo)) ? new C0143zza(iBinder) : (zzqo) queryLocalInterface;
        }
