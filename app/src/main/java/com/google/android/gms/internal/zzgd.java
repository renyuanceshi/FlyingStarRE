...
public interface zzgd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgd {
        ...
        private static class C0090zza implements zzgd {
        ...
        public static zzgd zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgd)) ? new C0090zza(iBinder) : (zzgd) queryLocalInterface;
        }
