...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        private static class C0083zza implements zzez {
        ...
        public static zzez zzG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C0083zza(iBinder) : (zzez) queryLocalInterface;
        }
