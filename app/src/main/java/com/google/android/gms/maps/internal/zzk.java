...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0193zza implements zzk {
        ...
        public static zzk zzcG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C0193zza(iBinder) : (zzk) queryLocalInterface;
        }
