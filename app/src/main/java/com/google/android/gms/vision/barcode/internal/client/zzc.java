...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C0242zza implements zzc {
        ...
        public static zzc zzee(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C0242zza(iBinder) : (zzc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zzb zza = zza(zzd.zza.zzbs(parcel.readStrongBinder()), parcel.readInt() != 0 ? BarcodeDetectorOptions.CREATOR.createFromParcel(parcel) : null);
