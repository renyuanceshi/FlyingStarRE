...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        private static class C0102zza implements zzla {
        ...
        public static zzla zzaz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C0102zza(iBinder) : (zzla) queryLocalInterface;
        }
