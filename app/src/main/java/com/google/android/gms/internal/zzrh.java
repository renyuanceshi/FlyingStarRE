...
public interface zzrh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrh {
        ...
        private static class C0147zza implements zzrh {
        ...
        public static zzrh zzdX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrh)) ? new C0147zza(iBinder) : (zzrh) queryLocalInterface;
        }
