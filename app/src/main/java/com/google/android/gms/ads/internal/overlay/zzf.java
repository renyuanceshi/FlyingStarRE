...
public class zzf implements Parcelable.Creator<AdOverlayInfoParcel> {
    static void zza(AdOverlayInfoParcel adOverlayInfoParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, (Parcelable) adOverlayInfoParcel.zzEA, i, false);
        ...
        zzb.zza(parcel, 14, (Parcelable) adOverlayInfoParcel.zzrl, i, false);
        zzb.zza(parcel, 15, adOverlayInfoParcel.zzfw(), false);
        zzb.zza(parcel, 17, (Parcelable) adOverlayInfoParcel.zzEM, i, false);
