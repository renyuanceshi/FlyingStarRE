...
public class zzh implements Parcelable.Creator<AdResponseParcel> {
    static void zza(AdResponseParcel adResponseParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 28, (Parcelable) adResponseParcel.zzIg, i, false);
        ...
        zzb.zza(parcel, 33, (Parcelable) adResponseParcel.zzIj, i, false);
    ...
    public AdResponseParcel createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < zzau) {
            ...
            switch (zza.zzca(zzat)) {
                ...
                case 33:
                    ...
                    break;
                case 34:
                    arrayList4 = zza.zzD(parcel, zzat);
                    break;
                case 35:
                    arrayList5 = zza.zzD(parcel, zzat);
                    break;
                case 36:
        ...
        if (parcel.dataPosition() == zzau) {
            return new AdResponseParcel(i, str, str2, arrayList, i2, arrayList2, j, z, j2, arrayList3, j3, i3, str3, j4, str4, z2, str5, str6, z3, z4, z5, z6, z7, i4, largeParcelTeleporter, str7, str8, z8, z9, rewardItemParcel, arrayList4, arrayList5, z10);
        }
