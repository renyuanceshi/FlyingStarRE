...
public interface zzcr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcr {
        ...
        private static class C0077zza implements zzcr {
        ...
        public static zzcr zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcr)) ? new C0077zza(iBinder) : (zzcr) queryLocalInterface;
        }
