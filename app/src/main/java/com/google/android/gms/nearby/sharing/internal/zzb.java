...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C0229zza implements zzb {
        ...
        public static zzb zzdG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C0229zza(iBinder) : (zzb) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 2:
                    ...
                    List<SharedContent> zzEO = zzEO();
                    parcel2.writeNoException();
                    parcel2.writeTypedList(zzEO);
                    return true;
                case 1598968902:
