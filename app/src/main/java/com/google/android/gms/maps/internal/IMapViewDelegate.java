...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapViewDelegate {
        ...
        private static class C0176zza implements IMapViewDelegate {
        ...
        public static IMapViewDelegate zzcz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C0176zza(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
