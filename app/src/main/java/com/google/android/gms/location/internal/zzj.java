...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class C0162zza implements zzj {
        ...
        public static zzj zzck(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C0162zza(iBinder) : (zzj) queryLocalInterface;
        }
