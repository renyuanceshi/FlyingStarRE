...
public interface zzsc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsc {
        ...
        private static class C0155zza implements zzsc {
        ...
        public static zzsc zzeo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsc)) ? new C0155zza(iBinder) : (zzsc) queryLocalInterface;
        }
