...
public interface zzfb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfb {
        ...
        private static class C0085zza implements zzfb {
        ...
        public static zzfb zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfb)) ? new C0085zza(iBinder) : (zzfb) queryLocalInterface;
        }
