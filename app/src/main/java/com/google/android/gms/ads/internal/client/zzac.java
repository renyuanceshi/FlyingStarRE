...
public class zzac {
    ...
    public zzac(Context context) {
        this(context, zzh.zzcO(), (PublisherInterstitialAd) null);
    }
    ...
    private void zzH(String str) throws RemoteException {
        ...
        if (this.zztA != null) {
            this.zzuL.zza((zzq) new zzc(this.zztA));
        }
        if (this.zztz != null) {
            this.zzuL.zza((zzp) new zzb(this.zztz));
        }
        if (this.zzun != null) {
            this.zzuL.zza((zzw) new zzj(this.zzun));
        }
        if (this.zzuO != null) {
            this.zzuL.zza((zzgd) new zzgi(this.zzuO));
        }
        if (this.zzuP != null) {
            this.zzuL.zza(new zzgm(this.zzuP), this.zzuM);
        }
        if (this.zzuQ != null) {
            this.zzuL.zza((zzcf) new zzcg(this.zzuQ));
        }
        if (this.zzuR != null) {
            this.zzuL.zza((zzx) this.zzuR.zzaF());
        }
        if (this.zzaX != null) {
            this.zzuL.zza((zzd) new zzg(this.zzaX));
        }
        if (this.zzaW != null) {
    ...
    public void setAdListener(AdListener adListener) {
        try {
            ...
            if (this.zzuL != null) {
                this.zzuL.zza((zzq) adListener != null ? new zzc(adListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setAppEventListener(AppEventListener appEventListener) {
        try {
            ...
            if (this.zzuL != null) {
                this.zzuL.zza((zzw) appEventListener != null ? new zzj(appEventListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setInAppPurchaseListener(InAppPurchaseListener inAppPurchaseListener) {
        ...
        try {
            ...
            if (this.zzuL != null) {
                this.zzuL.zza((zzgd) inAppPurchaseListener != null ? new zzgi(inAppPurchaseListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setOnCustomRenderedAdLoadedListener(OnCustomRenderedAdLoadedListener onCustomRenderedAdLoadedListener) {
        try {
            ...
            if (this.zzuL != null) {
                this.zzuL.zza((zzcf) onCustomRenderedAdLoadedListener != null ? new zzcg(onCustomRenderedAdLoadedListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setRewardedVideoAdListener(RewardedVideoAdListener rewardedVideoAdListener) {
        try {
            ...
            if (this.zzuL != null) {
                this.zzuL.zza((zzd) rewardedVideoAdListener != null ? new zzg(rewardedVideoAdListener) : null);
            }
        } catch (RemoteException e) {
            zzb.zzd("Failed to set the AdListener.", e);
        }
    ...
    public void zza(zza zza) {
        try {
            this.zztz = zza;
            if (this.zzuL != null) {
                this.zzuL.zza((zzp) zza != null ? new zzb(zza) : null);
            }
        } catch (RemoteException e) {
