...
public interface zzgh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgh {
        ...
        private static class C0094zza implements zzgh {
        ...
        public static zzgh zzT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgh)) ? new C0094zza(iBinder) : (zzgh) queryLocalInterface;
        }
