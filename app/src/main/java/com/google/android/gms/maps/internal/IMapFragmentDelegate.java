...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapFragmentDelegate {
        ...
        private static class C0175zza implements IMapFragmentDelegate {
        ...
        public static IMapFragmentDelegate zzcy(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C0175zza(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
