...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        private static class C0159zza implements zzg {
        ...
        public static zzg zzch(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzg)) ? new C0159zza(iBinder) : (zzg) queryLocalInterface;
        }
