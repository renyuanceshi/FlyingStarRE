...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICameraUpdateFactoryDelegate {
        ...
        private static class C0172zza implements ICameraUpdateFactoryDelegate {
        ...
        public static ICameraUpdateFactoryDelegate zzcs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? new C0172zza(iBinder) : (ICameraUpdateFactoryDelegate) queryLocalInterface;
        }
